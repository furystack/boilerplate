...
Add a REST endpoint end-to-end. Touches `common/`, `service/`, possibly `frontend/` (api client). Read `.cursor/rules/REST_SERVICE.mdc` and `.cursor/rules/LIBRARY_DEVELOPMENT.mdc` (REST Actions section) before authoring; this skill owns the workflow.
